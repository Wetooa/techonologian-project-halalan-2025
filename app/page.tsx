...
export default function Home() {
    ...
    return (
        <div
            className="bg-cover h-auto bg-center bg-[url('/graphics/background.png')] scroll-auto h-auto w-screen flex flex-col justify-center items-center gap-10 p-10">
            <Image
  ...
  `}
            ...
            <Image src={'/graphics/footer.png'} alt={"Footer"} width={400} height={400}></Image>
        </div>
